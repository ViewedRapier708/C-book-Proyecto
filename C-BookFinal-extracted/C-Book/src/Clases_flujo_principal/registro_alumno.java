...
public class registro_alumno {
 ...
 public static ArrayList<registro_alumno> registro = new ArrayList();
    public registro_alumno(int boleta_g, String actividad, int No_asignado, LocalDateTime  hora_entrada, LocalDateTime  hora_salida, int Numero_guardarropa) {
