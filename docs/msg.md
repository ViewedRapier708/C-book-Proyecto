Se debe de agregar los campos de observaciones , a las tablas de computadoras y restiradores

Se debe de modificar la tabla de libros en base a la que nos pasaron

Se debe de crear una tabla aparte para las solicitudes de los libros

Dejar la otra tabla de solicitudes para los restiradores y computadores

Se tiene que seguir checando la funcion de registro y login
