...
async function cargarDatosTabla() {
    ...
    const recorrido = (tbody, informacion) => {
        informacion.data.forEach(obj => {
    ...
    const peticion = await fetch(`http://localhost:3000/auth/recursos?tipo=${tipo}`, {// Ajusta la URL según tu configuración
        method: 'GET',
